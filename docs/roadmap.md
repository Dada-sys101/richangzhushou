...
→ AI-DECISION-001（DONE_INTEGRATION；PR #12；CI 218 SUCCESS）
→ PR2（DONE / DONE_LOCAL / UNCOMMITTED；MySQL 8.4.9 最终验收通过）→ PR5 / PR6 / PR9
...
PR2 已达到 `DONE / DONE_LOCAL`（UNCOMMITTED）；下一 canonical 任务为 PR5，但不得在未获新任务授权时自动开始。
