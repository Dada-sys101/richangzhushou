...
| OPEN-006 | 部署地域与对象存储 | 代码已实现并经 PR #6 squash 合并到 main（`db5c5d3`，main CI 通过）；真实 Bucket/RAM/连通测试未完成，OPEN-006 仍未完成 |
...
> PR #6 已 squash 合并到 main（`db5c5d3`），main CI 通过；尚需创建私有 Bucket、最小权限 RAM 凭据
