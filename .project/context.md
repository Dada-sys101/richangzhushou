...
2026-09-12 16:05 +08:00 — MOBILE-C3 PR #33 HEAD `b18b91d` is deployed to private preview with post-deployment checks passing; physical-device acceptance remains.
...
- Active delivery: MOBILE-C3 `VERIFYING / DONE_PUSHED / PR_33_OPEN / CI_PASS / PRIVATE_PREVIEW_DEPLOYED / DEVICE_ACCEPTANCE_PENDING`
...
Complete MOBILE-C3 date/month/date-time control acceptance on iPhone and Android, then decide whether to merge PR #33.
...
- The active release is `/opt/daily-assistant-preview/releases/b18b91d0-20260912T0735Z`; rollback release is `/opt/daily-assistant-preview/releases/b6208500-20260912T0627Z`. MOBILE-C3 custom temporal controls are live in private preview pending physical-device acceptance.
