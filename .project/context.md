...
2026-09-12 10:43 +08:00 — MOBILE-C1 commit `91c4fed` passes both CI matrices and is deployed to private preview; physical visual acceptance remains.
...
- Active delivery: MOBILE-C1 `DONE_PUSHED / PR_31_OPEN / CI_PASS / PRIVATE_PREVIEW_DEPLOYED / DEVICE_ACCEPTANCE_PENDING`
...
Complete MOBILE-C1 physical visual acceptance on the private preview, then prepare its merge decision.
