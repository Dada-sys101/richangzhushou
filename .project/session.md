...
- 后续截图确认空的必填提醒时间字段仅描边提示“今天”，未实际选中日期，导致“确定”仍置灰。现已改为打开时临时选中今天，取消时不写回表单；PR #38 已合入 Integration `8bbb302`，合并 CI `34823090430` 的 quality、db-validation、browser-qa 全绿。受保护备份 `daily_assistant_preview_20260914T084007Z.sql.gz` 后，私有预览已切换至 `8bbb3022-20260914T083606Z`；入口、提醒深链接、Manifest、Service Worker、新资源、服务和日志检查通过，等待 iPhone/Android 复验。
