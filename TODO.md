...
| DA-0301 | 补全 Finance OpenAPI、共享类型、错误码与契约测试 | IN_PROGRESS | WP3 |
| DA-0302 | Finance Prisma 实体、约束、索引、migration、seed 与回滚说明 | NOT_STARTED | WP3 |
| DA-0303 | 账单 CRUD、软删除/恢复与疑似重复提示 | NOT_STARTED | WP3 |
