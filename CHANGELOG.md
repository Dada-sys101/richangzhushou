...
- 修复后两组 CI 全绿；后续 `7103ad1` 修复退出登录和安装版更新，`77718a0` 修复认证数据库就绪并统一中文错误。当前部署为 `/opt/daily-assistant-preview/releases/77718a00-20260911T0713Z`，备份、目标顺序构建、公开数据库健康、中文登录错误响应和日志检查通过，旧 release 保留用于回滚。
